            ...
            Row(
              ...
              children: [
                Chip(
                  ...
                  //CircleAvatar
                  label: Text('All', style: TextStyle(fontSize: 16)), //Text
                ),
                Chip(
                  elevation: 15,
                  padding: EdgeInsets.all(8),
                  ...
                  label: Text('BMW', style: TextStyle(fontSize: 16)), //Text
                ),
                Chip(
                  elevation: 20,
                  padding: EdgeInsets.all(8),
                  ...
                  avatar: CircleAvatar(
                    backgroundImage: AssetImage("assets/tesla1.png"),
                  ), //CircleAvatar
                  label: Text('Tesla', style: TextStyle(fontSize: 16)), //Text
                ),
                Chip(
                  elevation: 20,
                  padding: EdgeInsets.all(8),
